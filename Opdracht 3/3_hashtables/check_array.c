...
START_TEST(test_add_resize) {
    ...
    ck_assert_int_eq(array_append(a, 2), 0);
    ck_assert_int_eq(array_append(a, 1), 0);
    ck_assert_uint_eq(array_size(a), 10);
    ...
    ck_assert_int_eq(array_get(a, 5), 3);
    ck_assert_int_eq(array_get(a, 6), 5);
    ck_assert_int_eq(array_get(a, 7), 7);
    ck_assert_int_eq(array_get(a, 8), 2);
    ck_assert_int_eq(array_get(a, 9), 1);
    array_cleanup(a);
}
END_TEST
